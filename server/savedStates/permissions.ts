...
export const ROLE_RANK = Object.freeze({ view: 1, edit: 2, admin: 3, owner: 4 });
...
export function canView(role) { return hasAtLeast(role, 'view'); }
export function canEdit(role) { return hasAtLeast(role, 'edit'); }
export function canDelete(role) { return role === 'admin' || role === 'owner'; }
export function canManageShares(role) { return role === 'admin' || role === 'owner'; }
export function canTransferOwner(role) { return role === 'owner'; }
